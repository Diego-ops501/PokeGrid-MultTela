...
- **🗣️ Voz dos alertas**: usa uma voz instalada no Windows e fala a conta envolvida. Anuncia shiny aparecendo, sucesso ou falha final da captura, **Strange Pheromones**, **Boss Token**, Pokébolas/curas acabando e capturas exatamente da faixa Lendária. Mítica, Anciã e Divina não são chamadas de Lendária
